                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="{{url('teach/methods')}}">Teach Method</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        ...
                        <div class="main_direct" id="teach_method">                                  
                            <form name="teach_method" role="form" action="{{url('teach/methods/add')}}" method="post" class="inputs">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <tr>
                                            <td>{{ $teach_method->id }}</td>
                                            <td>{{  $teach_method->name  }}</td>
                                            <td><a class="btn btn-danger" href="{{ url('teach/methods/delete/'.$teach_method->id) }}">Delete</a></td>
                                            <td>Edit</td>
                                        </tr>
                                        @endforeach
                                    </table>
