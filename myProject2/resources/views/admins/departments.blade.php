                ...
                <div class="content col-xs-12">
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        ...
                        <div class="main_direct" id="departments">    
                                <form name="departments" method="post" action="{{url('departments/add')}}" role="form" class="inputs">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-danger" href="{{ url('departments/delete/'.$department->id) }}">Delete</a></td>
                                            <td>Edit</td>
                                        </tr>
                                        @endforeach
                                    </table>
