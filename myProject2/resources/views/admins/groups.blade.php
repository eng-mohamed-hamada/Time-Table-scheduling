                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="{{url('groups')}}">Groups</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        ...
                        <div class="main_direct" id="degrees">                                 
                            <form name="degrees" method="post" action="{{url('groups/add')}}" role="form" class="inputs">
                            ...
                            <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <tr>
                                            <td>{{ $group->id }}</td>
                                            <td>{{  $group->name  }}</td>
                                            <td><a class="btn btn-danger" href="{{ url('groups/delete/'.$group->id) }}">Delete</a></td>
                                            <td>Edit</td>
                                        </tr>
                                        @endforeach
                                    </table>
