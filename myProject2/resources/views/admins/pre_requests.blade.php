                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="{{url('pre_requests')}}">Pre Requests</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        ...
                        <div class="main_direct" id="department_subjects">                               
                                <form name="department_subjects" method="post" action="{{url('pre_requests/add')}}" role="form" class="inputs">
                                            ...
                                            <table class="table table-striped table-bordered table-hover text-center text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="checkbox form-check">
                                                        <label>
                                                            <input class="time_slots" name="pre_request_code[]" type="checkbox" value="{{$subject->code}}"> <span class="label-text"></span>
                                                        </label>
                                                    </div>
                                                    </td>
                                                </tr>
