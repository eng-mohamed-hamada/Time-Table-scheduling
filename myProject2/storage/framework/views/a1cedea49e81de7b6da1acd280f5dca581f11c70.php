                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo e(url('teach/methods')); ?>">Teach Method</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        <div class="active col-xs-12 text-left">Teach Method</div>
                        <div class="main_direct" id="teach_method">                                  
                            <form name="teach_method" role="form" action="<?php echo e(url('teach/methods/add')); ?>" method="post" class="inputs">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <?php $__currentLoopData = $teach_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teach_method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($teach_method->id); ?></td>
                                            <td><?php echo e($teach_method->name); ?></td>
                                            <td><a class="btn btn-danger" href="<?php echo e(url('teach/methods/delete/'.$teach_method->id)); ?>">Delete</a></td>
                                            <td>Edit</td>
                                        </tr>
