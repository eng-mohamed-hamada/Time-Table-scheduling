                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo e(url('degrees')); ?>">Degrees</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        <div class="active col-xs-12 text-left">Degrees</div>
                        <div class="main_direct" id="degrees">                                 
                                <form name="degrees" method="post" action="<?php echo e(url('degrees/add')); ?>" role="form" class="inputs">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="button" value="Show Degrees" class="btn btn-primary">
                                        </div>
                                </form>
                                <div class="outputs">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <tr>
                                            <td><?php echo e($degree->id); ?></td>
                                            <td><?php echo e($degree->name); ?></td>
                                            <td><a class="btn btn-danger" href="<?php echo e(url('degrees/delete/'.$degree->id)); ?>">Delete</a></td>
                                        </tr>
