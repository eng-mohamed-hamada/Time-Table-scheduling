                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo e(url('department/subjects')); ?>">Department Subjects</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        ...
                        <div class="main_direct" id="department_subjects">                               
                                <form name="department_subjects" method="post" action="<?php echo e(url('department/subjects/add')); ?>" role="form" class="inputs">
