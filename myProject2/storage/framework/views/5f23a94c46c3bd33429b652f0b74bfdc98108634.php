                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo e(url('departments')); ?>">Departments</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        <div class="active col-xs-12 text-left">Departments</div>
                        <div class="main_direct" id="departments">    
                                <form name="departments" method="post" action="<?php echo e(url('departments/add')); ?>" role="form" class="inputs">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input disabled type="submit" value="update" class="btn btn-primary">
                                                <input type="button" value="Show All" class="btn btn-primary">
                                                <input type="reset" value="reset" class="btn btn-primary">
                                        </div>
                                </form>
                                <div id="departments_outputs" class="outputs">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-danger" href="<?php echo e(url('departments/delete/'.$department->id)); ?>">Delete</a></td>
                                            <td>Edit</td>
                                        </tr>
