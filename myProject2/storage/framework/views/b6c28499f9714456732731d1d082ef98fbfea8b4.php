                ...
                <div class="content col-xs-12">
                    <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo e(url('groups')); ?>">Groups</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        <div class="active col-xs-12 text-left">Groups</div>
                        <div class="main_direct" id="degrees">                                 
                            <form name="degrees" method="post" action="<?php echo e(url('groups/add')); ?>" role="form" class="inputs">
                            ...
                            <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-danger" href="<?php echo e(url('groups/delete/'.$group->id)); ?>">Delete</a></td>
                                            <td>Edit</td>
                                        </tr>
