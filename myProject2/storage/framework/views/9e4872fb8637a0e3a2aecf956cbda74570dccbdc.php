            ...
            <div class="row">
                ...
                <div class="sidebar col-xs-6 col-sm-3 col-md-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo e(url('students')); ?>">Students</a></li>
                    ...
                    <div class="main_content col-sm-9 col-md-10">
                        ...
                        <div class="main_direct" id="students">                                   
                                <form name="students" method="post" action="<?php echo e(url('students/add')); ?>" role="form" class="inputs">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover text-center text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($student->depart_id); ?></td>
                                            <td><?php echo e($student->level_group_id); ?></td>
                                            <td><a class="btn btn-danger" href="<?php echo e(url('students/delete/'.$student->id)); ?>">Delete</a></td>
                                            <td>Edit</td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </table>
